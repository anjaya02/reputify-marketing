...
import { Chrome, Facebook, Linkedin, Youtube, MessageCircle } from "lucide-react"
    ...
    <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Comprehensive Platform Coverage</h2>
