...
export const metadata: Metadata = {
  ...
  keywords: ["reputation management", "review monitoring", "Sri Lanka", "AI", "sentiment analysis", "business", "SME"],
  authors: [{ name: "Team Y3-05" }],
  openGraph: {
    title: "Reputify - AI Reputation Management for Sri Lankan Businesses",
    description: "Transform your business reputation with AI-powered monitoring and insights",
    type: "website",
  },
    generator: 'v0.app'
}
